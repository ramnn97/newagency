        ...
        <div className="container mx-auto px-6 grid lg:grid-cols-1 gap-12 items-center min-h-[calc(100vh-180px)]">
          ...
          <div className="space-y-8 flex flex-col items-center justify-center">
            <div className="space-y-4 text-center">
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-black leading-[0.95] tracking-tight flex flex-wrap items-center justify-center gap-4">
                ...
                <SparklesText 
                  ...
                  sparklesCount={10}
                  className="text-3xl md:text-5xl lg:text-6xl font-black animate-fade-in-up text-white"
                />
              </h1>
